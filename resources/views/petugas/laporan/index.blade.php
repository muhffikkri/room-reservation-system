...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-2 gap-4 sm:grid-cols-5">
        <a href="{{ route('petugas.laporan.index') }}" class="rounded-xl border p-4 shadow-sm transition {{ empty($status) ? 'border-[#0051d5] bg-[#F2F3FF] ring-2 ring-[#E2E7FF]' : 'border-[#E2E7FF] bg-white hover:border-[#D6DDF8]' }}">
        ...
        <a href="{{ route('petugas.laporan.index', ['status' => 'baru']) }}" class="rounded-xl border p-4 shadow-sm transition {{ $status === 'baru' ? 'border-sky-600 bg-sky-50/50 ring-2 ring-sky-200' : 'border-[#E2E7FF] bg-white hover:border-[#D6DDF8]' }}">
            <div class="text-xs font-semibold text-sky-600">Baru</div>
            <div class="mt-2 text-2xl font-semibold text-sky-700">{{ $counts['baru'] }}</div>
        </a>
        <a href="{{ route('petugas.laporan.index', ['status' => 'diproses']) }}" class="rounded-xl border p-4 shadow-sm transition {{ $status === 'diproses' ? 'border-amber-600 bg-amber-50/50 ring-2 ring-amber-200' : 'border-[#E2E7FF] bg-white hover:border-[#D6DDF8]' }}">
        ...
        <a href="{{ route('petugas.laporan.index', ['status' => 'selesai']) }}" class="rounded-xl border p-4 shadow-sm transition {{ $status === 'selesai' ? 'border-emerald-600 bg-emerald-50/50 ring-2 ring-emerald-200' : 'border-[#E2E7FF] bg-white hover:border-[#D6DDF8]' }}">
        ...
        <a href="{{ route('petugas.laporan.index', ['status' => 'ditolak']) }}" class="rounded-xl border p-4 shadow-sm transition {{ $status === 'ditolak' ? 'border-rose-600 bg-rose-50/50 ring-2 ring-rose-200' : 'border-[#E2E7FF] bg-white hover:border-[#D6DDF8]' }}">
