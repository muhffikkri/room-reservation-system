...
@section('content')
    <div class="mx-auto max-w-2xl">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div>
                <h1 class="text-2xl font-bold tracking-tight text-slate-900">Edit {{ $facility->name }}</h1>
                <p class="mt-1 text-sm text-slate-600">Ubah data fasilitas. Kosongkan foto untuk mempertahankan foto saat ini.</p>
            </div>
